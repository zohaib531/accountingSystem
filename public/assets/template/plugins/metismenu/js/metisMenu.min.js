        ...
        (s = (function () {
            ...
            return (
                ...
                (n.show = function (n) {
                    ...
                    if (
                        !this.transitioning &&
                        !o(n).hasClass(this.config.collapsingClass)
                    ) {
                        var i = o(n),
                            t = o.Event(c.SHOW);
                            ...
                            i.height(n[0].scrollHeight)
                                .one(g.TRANSITION_END, function () {
                                    e.config &&
                                        ...
                                        (i
                                            .removeClass(
                                                e.config.collapsingClass
                                            )
                                            .addClass(
                                                e.config.collapseClass +
                                                    " " +
                                                    e.config.collapseInClass
                                            )
                                            .height(""),
                ...
                (n.hide = function (n) {
                    ...
                    if (
                        !this.transitioning &&
                        o(n).hasClass(this.config.collapseInClass)
                    ) {
                        var i = o(n),
                            t = o.Event(c.HIDE);
                        if ((i.trigger(t), !t.isDefaultPrevented())) {
                            ...
                            var s = function () {
                                e.config &&
                                    e.element &&
                                    (e.transitioning &&
                                        e.config.onTransitionEnd &&
                                        e.config.onTransitionEnd(),
                                    e.setTransitioning(!1),
                                    i.trigger(c.HIDDEN),
                                    i
                                        .removeClass(e.config.collapsingClass)
                                        .addClass(e.config.collapseClass));
                            };
                ...
                (s.jQueryInterface = function (t) {
                    return this.each(function () {
                        ...
                        if (
                            (!e && /dispose/.test(t) && this.dispose(),
                            e || ((e = new s(this, i)), n.data(r, e)),
                            "string" == typeof t)
                        ) {
                            if (void 0 === e[t])
