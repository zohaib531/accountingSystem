                                    ...
                                    <div class="row mb-xl-1 mb-9">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" value=""  placeholder="Enter Name" class="form-control h-px-48" />
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                @foreach($permission as $value)
                                                    <label class="col-md-4" ><input class="mr-3" type="checkbox" name="permission[]" value="{{ $value->name  }}" /> {{ $value->name  }}</label>
                                                @endforeach
                                            </div>
                                        </div>
                                    </div>
