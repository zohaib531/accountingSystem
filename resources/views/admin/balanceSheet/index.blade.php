                ...
                <div class="card-body">
                    ...
                    <form method="post" id="create-form">
                        ...
                        <div class="row mx-0 mb-5 align-items-end">
                            ...
                            <div class="col-3">
                                <button type="button" class="btn btn-primary" onclick="commonFunctionForAllRequest(true,false,'.trialBalancePortion','{{route('getbalanceSheet')}}','','post','','create-form');">Create Report</button>
                            </div>
                        </div>
