                    ...
                    <div class="form-validation row justify-content-center">
                        <form class="form-valide col-6" id="update-form">
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <select class="form-control" id="val-category" name="category_id" onchange="categoryChange(this)">
                                                            ...
                                                            @foreach ($categories as $category)
                                                                <option  {{$product->category_id==$category->id?'selected':''}} value="{{$category->id}}" data-code="{{str_pad($category->code, 2, '0', STR_PAD_LEFT)}}">{{$category->title}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-success text-white" data-dismiss="modal">Save</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <input type="number" class="form-control" id="product-code" name="product_code" value="{{$product->product_code}}" placeholder="00000000" readonly>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-form-label" for="product-title">Product title<span class="text-danger">*</span></label>
                                <div>
                                    <input type="text" class="form-control" id="product-title" value="{{$product->title}}" name="title" placeholder="Enter a product title..">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-form-label" for="product-price">Product price<span class="text-danger">*</span></label>
                                <div>
                                    <input type="number" class="form-control" id="product-price" name="price" value="{{$product->price}}" placeholder="Enter a product price..">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-form-label" for="product-quantity">Product quantity<span class="text-danger">*</span></label>
                                <div>
                                    <input type="number" class="form-control" id="product-quantity" name="quantity" value="{{$product->quantity}}" placeholder="Enter a product quantity..">
                                </div>
                            </div>
                            <div class="d-flex justify-content-between">
                                ...
                                <div>
                                    <img src="{{$product->img}}" id="updateImage" alt="" width="100" height="100" style="object-fit: contain">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-form-label" for="product-descripton">Product descripton<span class="text-danger">*</span></label>
                                <div>
                                    <textarea class="form-control" name="description" id="product-descripton"  placeholder="Enter a product descripton.."  cols="30" rows="10">{{$product->description}}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
